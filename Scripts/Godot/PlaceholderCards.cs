...
namespace TFCardBattle.Godot
{
    public static class PlaceholderCards
    {
        ...
        {
            yield return BrainCard("Quick Thinking", brainCost: 3, damage: 1, shield: 1, brain: 1);
            yield return BrainCard("Spreadsheet Master", brainCost: 2, brain: 1, shield: 1);
            yield return BrainCard("Motivational Poster", brainCost: 3, brain: 1, damage: 2);
            yield return BrainCard("Phone a Friend", brainCost: 3, brain: 1, draw: 1);
            yield return BrainCard("Firewall", brainCost: 3, shield: 3);
            yield return BrainCard("Hypnotic Email", brainCost: 5, damage: 4);
            ...
            yield return BrainCard("Counter Measures", brainCost: 4, damage: 2, shield: 2);
            yield return BrainCard("Evil Therapist", brainCost: 7, damage: 3, draw: 2);
            ...
            yield return HeartCard("Cam Girl", heartCost: 3, heart: 2, damage: 1, shield: 1);
            yield return HeartCard("Beauty Regimen", heartCost: 2, shield: 1, draw: 1);
            yield return HeartCard("Just a Lick", heartCost: 2, damage: 1, draw: 1);
            yield return HeartCard("Bribe the Intern", heartCost: 1, damage: 2);
            yield return HeartCard("Crotch Grab", heartCost: 3, heart: 3);
            yield return HeartCard("Date Night", heartCost: 3, heart: 2, shield: 2);
            yield return HeartCard("Sixty-Nine", heartCost: 4, damage: 3, heart: 3);
            ...
            yield return HeartCard("Seduce the Cable Guy", heartCost: 3, damage: 2, draw: 1);
            yield return HeartCard("Back to His Place", heartCost: 3, shield: 3, damage: 2);
            yield return HeartCard("Sugar Daddy", heartCost: 2, shield: 3);

            yield return SubCard("Bow Down", subCost: 1, damage: 1, sub: 2);
            ...
            yield return SubCard("Underfoot", subCost: 1, damage: 2, shield: 1);
            yield return SubCard("Blindfolded", heartCost: 2, sub: 1, draw: 1);
            yield return SubCard("Creampie", heartCost: 7, sub: 5, draw: 2);
            yield return SubCard("Pounded", heartCost: 5, damage: 2, sub: 2, draw: 1);
            ...
            yield return SubCard("Air Tight", subCost: 5, damage: 3, shield: 3, sub: 3);
            ...
            yield return SubCard("Gangbang", subCost: 5, damage: 10);
